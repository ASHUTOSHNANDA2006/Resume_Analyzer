...
const interviewReportSchema = z.object({
    matchScore: z.number().min(0).max(100).description("The overall match score between the candidate and the job description, calculated based on various factors such as skills, experience, etc."),
