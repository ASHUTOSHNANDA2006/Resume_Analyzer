...
const interviewReportSchema = z.object({
    ...
    tasks: z.array(z.string()).description("List of tasks to be completed on this day to follow the preparation plan comlete, e.g. read a specific book, solve a set of problems, watch a set of videos etc.")
