...
const interviewReportSchema = z.object({
    ...
    tasks: z.array(z.string()).description("List of tasks to be completed on this day to follow the preparation plan, e.g. read a specific book, solve a set of problems, watch a set of videos etc.")
    })).description("A day-wise preparation plan for the candidate to prepare for the interview, with specific focus and tasks for each day so that they can prepare effectively and realistaically for the interview.")
})
