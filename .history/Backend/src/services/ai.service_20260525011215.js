...
const interviewReportSchema = z.object({
    matchScore: z.number().min(0).max(100).description("The overall match score between the candidate and the job description, calculated based on various factors such as skills, experience, etc. on a "),
    atsScore: z.number().min(0).max(100).description("The ATS score of the candidate's resume, which indicates how well the resume is optimized for Applicant Tracking Systems used by employers to screen resumes."),
